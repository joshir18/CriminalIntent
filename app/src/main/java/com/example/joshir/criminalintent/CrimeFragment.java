...
public class CrimeFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        mTimeButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                dialog.setTargetFragment(CrimeFragment.this, REQUEST_TIME); // might be time
        ...
        mRequiresPolice = (CheckBox) v.findViewById(R.id.crime_police);
    ...
    private void updateTime(){
        Date date = mCrime.getDate();
        mTimeButton.setText(DateFormat.getTimeInstance(DateFormat.SHORT).format(date));
    }
}
